...
$app->post('/decrease-product',UserProductController::class, 'decreaseProduct');
$app->post('/product-page',ProductController::class, 'getProductPage');
$app->post('/addReview',ProductController::class, 'addReview');
$app->post('/add-product',UserProductController::class, 'addProduct');
